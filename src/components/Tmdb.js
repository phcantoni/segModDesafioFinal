...
export default {
        ...
        return [
            {
                ...
                path: await basicFetch(`/movie/now_playing?api_key=${API_KEY}&language=pt-BR`),
                isLarge: false
            }
        ];
    },
    getHomeListTwo: async () => {
        return [
            {
                slug: "trending",
                title: "Em Alta",
    ...
    getHomeListSeriesTwo: async () => {
        return [
            {
                slug: "trending",
                title: "Em Alta",
                path: await basicFetch(`/tv/top_rated?api_key=${API_KEY}&language=pt-BR`),
                isLarge: true
            }
        ];
    },
